            ...
            switch (toolbarTab.intValue)
            {
                ...
                case 1:
                    if (Application.isPlaying) //Make sure motor physical properties cannot be editted during playmode
                    {
                        ...
                        EditorGUILayout.LabelField("Max Number of Redirections", component.MaxNumberOfHits.ToString());
                    ...
                    {
                        component.Reach = EditorGUILayout.FloatField("Reach", component.Reach);
                        ...
                        component.MaxNumberOfHits = EditorGUILayout.IntField("Max Number of Redirections", component.MaxNumberOfHits);
