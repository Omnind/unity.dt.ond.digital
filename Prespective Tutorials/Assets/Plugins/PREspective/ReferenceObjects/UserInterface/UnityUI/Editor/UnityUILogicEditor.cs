...
namespace u040.prespective.referenceobjects.userinterface.unityui.editor
{
    ...
    public class UnityUILogicEditor : PrespectiveEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                case 0:
                    EditorGUILayout.LabelField("Inputs", new GUIStyle() { fontStyle = FontStyle.Bold });
                    ...
                    {
                        EditorGUILayout.LabelField("No inputs defined", new GUIStyle() { fontStyle = FontStyle.Italic });
                    }
                    EditorGUI.indentLevel--;
                ...
                case 1:
                    EditorGUILayout.LabelField("Last triggered", new GUIStyle() { fontStyle = FontStyle.Bold });
                    EditorGUI.indentLevel++;
